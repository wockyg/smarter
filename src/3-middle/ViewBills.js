...
import useGetD1500ViewClaim from '../hooks/useGetD1500ViewClaim';
import useGetD1500ViewHcfa from '../hooks/useGetD1500ViewHcfa';
...
export default function ViewBills() {
    ...
    const { status: statusBills, data: bills, error: errorBills, isFetching: isFetchingBills } = useGetD1500ViewClaim(linkId);
