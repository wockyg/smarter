...
import useAddCasemanager from '../hooks/useAddCaseManager';
import {states} from '../lookup-tables/lookup_UsState'

export default function CasemanagerAddForm() {

    const mutationAdd = useAddCasemanager();
    ...
    return (
        <div>
            ...
            onSubmit={(values, actions) => {
                ...
                console.log("adding casemanager...", values);
