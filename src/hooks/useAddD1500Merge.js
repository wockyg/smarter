...
export default function useAddD1500Merge() {
    ...
    api.post('/d1500/merge', values,
        ...
        .then(response => {
          if (response.status === 200) {
            console.log("Successfully posted d1500 (merge) to db...");
  ...
  return useMutation( (values) => addD1500Merge(values), 
                      {onSuccess: () => {
                      console.log('successfully submitted D1500 (merge) for processing...');
                      }});
