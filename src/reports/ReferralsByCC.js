...
export default function ReferralsByCC(props) {
            ...
            <Table stickyHeader size="small" aria-label="referralsByCC table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell sx={{ fontSize: 12, padding: 0.5 }}><u>Status</u></TableCell>
                        <TableCell sx={{ fontSize: 12, padding: 0.5 }}><u># FIles</u></TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {careCoordinators && careCoordinators.map((row, j) => {

                                    // console.log(row.rowData);

                                    const ccReferrals = referrals?.filter(r => r.assign === row.Initials);
